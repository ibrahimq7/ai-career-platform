...
SECTION_HEADERS = [
    ...
    "it competencies and experience", "projects", "project", "project experience", "academic projects",
    "personal projects", "key projects", "major projects", "notable projects", "selected projects",
    "selected work", "portfolio", "case studies", "certifications", "summary", "objective", "activities", "interests",
